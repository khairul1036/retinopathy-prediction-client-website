        ...
        <div className=" bg-[#F2FAFF] ">
            ...
            <div className="container mx-auto flex flex-col-reverse md:flex-row justify-between items-center px-5 md:px-10 lg:px-4 py-16 lg:max-h-screen gap-5">
                ...
                <div className="flex-1 flex flex-col gap-5">
                    {/* Text */}
                    <div className="">
                        <h1 className="text-5xl md:text-5xl lg:text-7xl font-bold text-[#031B4E]">Smarter <span className="text-[#0aa7c3]">eye checks</span> for healthier vision</h1>
                ...
                <div className="w-80 mx-auto md:w-[450px] lg:w-[541px] lg:h-full lg:relative">
                    <img className="w-full h-full" src="https://miro.medium.com/v2/resize:fit:1400/1*Om8kniLZCpQbf1oznWCvFA.png" alt="" />
