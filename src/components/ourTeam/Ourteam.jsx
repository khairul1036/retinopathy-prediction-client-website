  ...
  return (
    <div className="max-w-11/12 mx-auto">
      <div>
        <div className="text-center py-10">
          <h1 className="text-4xl font-bold uppercase">
            meet <span className="text-[#00BDE0]">our team</span>
          </h1>
        </div>
      </div>
      {/* <Carousel
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        <div className="group saturate-100 transition-[filter] relative w-[248px] h-[318px] bg-sky-500 border-b-2 border-b-sky-500">
          <img
            className="rounded-br-[100px] transition-[border-radius] h-[245px] items-center"
            src="https://api.empowernextgenbd.com/uploads/681508d3542aa_image.jpg"
          />
          <p className="m-[5px] text-xl font-semibold">Khairul Islam</p>
          <p className="m-[5px] text-gray-800 text-base">212-15-4102</p>

          <svg
            className="opacity-100 transition-opacity absolute right-[10px] bottom-[10px] text-blue-500"
        ...
        <div className="group saturate-100 transition-[filter] relative w-[248px] h-[318px] bg-sky-500 border-b-2 border-b-sky-500">
          <img
            className="rounded-br-[100px] transition-[border-radius] h-[245px] items-center"
            src="https://api.empowernextgenbd.com/uploads/681508ef676c7_image.jpg"
          />
          <p className="m-[5px] text-xl font-semibold">Mosaidur Rahman Asif</p>
          <p className="m-[5px] text-gray-800 text-base">212-15-4194</p>
        ...
        <div className="group saturate-100 transition-[filter] relative w-[248px] h-[318px] bg-sky-500 border-b-2 border-b-sky-500">
          <img
            className="rounded-br-[100px] transition-[border-radius] h-[245px] items-center"
            src="https://api.empowernextgenbd.com/uploads/6815089e67414_image.jpg"
          />
          <p className="m-[5px] text-base font-semibold z-50">
            Mr. Raja Tariqul Hasan Tusher
          </p>
          <p className="m-[5px] text-gray-800 text-base">Supervisor</p>
        ...
        <div className="group saturate-100 transition-[filter] relative w-[248px] h-[318px] bg-sky-500 border-b-2 border-b-sky-500">
          <img
            className="rounded-br-[100px] transition-[border-radius] h-[245px] items-center"
            src="https://api.empowernextgenbd.com/uploads/681508bbeda44_image.jpg"
          />
          <p className="m-[5px] text-base font-semibold z-50">
            Mr. Md Atik Asif Khan Akash
          </p>
          <p className="m-[5px] text-gray-800 text-base">Co-Supervisor</p>
