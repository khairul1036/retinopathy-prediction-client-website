        ...
        <div className="max-w-11/12 mx-auto">
            ...
            >
                <div
                    ...
                    <p className="m-[5px] text-xl font-semibold">Khairul Islam</p>
                    <p className="m-[5px] text-gray-600 text-base">212-15-4102</p>
                ...
                <div
                    ...
                    <img
                        className="group-hover:rounded-br-[100px] rounded-br-[0px] transition-[border-radius] h-[245px] items-center"
                        src="https://clinicmaster.wprdx.com/medical/wp-content/uploads/2024/08/team4.png" />
                    <p className="m-[5px] text-xl font-semibold">Mosaidur Rahman Asif</p>
                    <p className="m-[5px] text-gray-600 text-base">212-15-4194</p>
